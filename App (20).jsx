...
import {
  ...
  SlidersHorizontal, Gauge, Cog, Printer, ArrowUp, ArrowDown, MessageCircle,
} from "lucide-react";
import {
...
/* ============================================================
   ...
   ============================================================ */
const WORKERS = [
  { id: "u1", username: "admin", password: "admin123", name: "Jose Garrido", role: "Administrador", cargo: "Dirección General", email: "jose@jgbcars.com", phone: "+34 611 222 333" },
...
const TASKS_SEED = [
  ...
  { id: "T-04", titulo: "Cerrar financiación Golf GTI", desc: "Enviar documentación a la financiera de Marc Vidal.", responsable: "Jose Garrido", prioridad: "Alta", limite: "2026-09-16", estado: "En proceso" },
...
const MESSAGES_SEED = [
  { id: "M-01", de: "Jose Garrido", texto: "Recordad: cierre mensual de contabilidad el viernes.", fecha: "2026-09-10 09:12", tipo: "Aviso general" },
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-10">
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <a href={`https://wa.me/34625824554?text=Hola%2C%20me%20interesa%20el%20${encodeURIComponent(v.marca + " " + v.modelo)}%20que%20tenéis%20en%20stock.`}
      ...
      <div className="max-w-7xl mx-auto px-5 py-10">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3 mb-8 p-3 rounded-xl" style={{ background: C.surface, border: `1px solid ${C.border}` }}>
          <div className="flex gap-2 flex-wrap items-center">
            ...
            <select style={{ ...inputStyle, width: 190 }} value={sort} onChange={(e) => setSort(e.target.value)}>
              <option value="recientes">Destacados primero</option>
        ...
        <div className="mt-16 rounded-2xl p-8 md:p-10 grid md:grid-cols-2 gap-8 items-center" style={{ background: C.surface, border: `1px solid ${C.border}` }}>
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:justify-end">
            <a href="https://wa.me/34625824554?text=Hola%2C%20estoy%20buscando%20un%20coche%20concreto%20y%20me%20gustar%C3%ADa%20que%20me%20ayud%C3%A9is%20a%20encontrarlo."
              target="_blank" rel="noopener noreferrer" className="jgb-btn font-semibold text-sm rounded-lg px-4 py-2.5 text-center"
...
function AvisoLegalPage() {
  return (
    <div>
      ...
      <div className="max-w-3xl mx-auto px-5 py-16 text-sm leading-relaxed" style={{ color: C.muted }}>
        <p className="mb-4">En cumplimiento del deber de información recogido en el artículo 10 de la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y del Comercio Electrónico, se facilitan los siguientes datos:</p>
        <div className="rounded-xl p-5 mb-6" style={{ background: C.surface, border: `1px solid ${C.border}` }}>
          <div><b style={{ color: C.ink }}>Titular:</b> JGB Cars</div>
          <div><b style={{ color: C.ink }}>CIF:</b> [pendiente de asignar]</div>
          <div><b style={{ color: C.ink }}>Domicilio:</b> Sin sede física — atención online</div>
          <div><b style={{ color: C.ink }}>Email:</b> info@jgbcars.com</div>
        </div>
        <h2 className="text-base font-bold mb-2" style={{ color: C.ink }}>Objeto</h2>
        <p className="mb-4">El presente aviso legal regula el uso del sitio web jgbcars.com, cuya finalidad es informar sobre los servicios de compraventa e importación de vehículos ofrecidos por JGB Cars y facilitar el contacto con potenciales clientes.</p>
        <h2 className="text-base font-bold mb-2" style={{ color: C.ink }}>Condiciones de uso</h2>
        <p className="mb-4">El acceso a este sitio web es gratuito y no requiere registro previo. El usuario se compromete a hacer un uso adecuado de los contenidos y servicios que JGB Cars ofrece a través de su web, y a no emplearlos para incurrir en actividades ilícitas o contrarias a la buena fe.</p>
        <h2 className="text-base font-bold mb-2" style={{ color: C.ink }}>Propiedad intelectual</h2>
        <p className="mb-4">Los contenidos de este sitio web (textos, imágenes, diseño y código) son propiedad de JGB Cars o de terceros que han autorizado su uso, y están protegidos por la normativa de propiedad intelectual e industrial.</p>
        <h2 className="text-base font-bold mb-2" style={{ color: C.ink }}>Legislación aplicable</h2>
        <p>Las presentes condiciones se rigen por la legislación española. Para cualquier controversia derivada del uso de este sitio web, las partes se someten a los juzgados y tribunales que correspondan según la normativa vigente en materia de consumidores.</p>
      </div>
    </div>
  );
}
...
function PrivacidadPage() {
  return (
    <div>
      <PageHeader eyebrow="Información legal" title="Política de Privacidad" />
      <div className="max-w-3xl mx-auto px-5 py-16 text-sm leading-relaxed" style={{ color: C.muted }}>
        <p className="mb-4">En JGB Cars nos tomamos en serio la protección de tus datos personales. Esta política explica qué datos recogemos, con qué finalidad y qué derechos tienes al respecto, de acuerdo con el Reglamento General de Protección de Datos (RGPD) y la Ley Orgánica 3/2018 (LOPDGDD).</p>
        <h2 className="text-base font-bold mb-2" style={{ color: C.ink }}>Responsable del tratamiento</h2>
        <p className="mb-4">JGB Cars, con CIF [pendiente de asignar] y email de contacto info@jgbcars.com, es el responsable de los datos que nos facilitas a través del formulario de contacto.</p>
        <h2 className="text-base font-bold mb-2" style={{ color: C.ink }}>Qué datos recogemos</h2>
        <p className="mb-4">A través del formulario de contacto recogemos tu nombre, email, teléfono y el mensaje que nos envías, junto con el motivo de contacto que selecciones.</p>
        <h2 className="text-base font-bold mb-2" style={{ color: C.ink }}>Finalidad</h2>
        <p className="mb-4">Utilizamos estos datos exclusivamente para responder a tu consulta y, si procede, gestionar la compraventa o importación del vehículo en el que estés interesado. No utilizamos tus datos para fines distintos a los que motivaron el contacto.</p>
        <h2 className="text-base font-bold mb-2" style={{ color: C.ink }}>Conservación</h2>
        <p className="mb-4">Conservamos tus datos mientras dure la relación comercial y, posteriormente, durante los plazos legalmente exigidos para atender eventuales responsabilidades.</p>
        <h2 className="text-base font-bold mb-2" style={{ color: C.ink }}>Cesión a terceros</h2>
        <p className="mb-4">No cedemos tus datos a terceros, salvo obligación legal o cuando sea necesario para gestionar la operación (por ejemplo, gestorías o financieras, y solo con tu conocimiento).</p>
        <h2 className="text-base font-bold mb-2" style={{ color: C.ink }}>Tus derechos</h2>
        <p>Puedes ejercer tus derechos de acceso, rectificación, supresión, oposición, limitación y portabilidad escribiendo a info@jgbcars.com. También puedes reclamar ante la Agencia Española de Protección de Datos (aepd.es) si consideras que no hemos atendido tu solicitud correctamente.</p>
      </div>
    </div>
  );
}

function ContactPage({ form, setForm, errors, sent, submit, goto }) {
  const FAQ = [
      ...
      <div className="max-w-6xl mx-auto px-5 py-16 grid md:grid-cols-2 gap-12">
        <div>
          <div className="space-y-4 text-sm mb-8">
            {[[Phone, "+34 625 82 45 54"], [Mail, "info@jgbcars.com"], [MapPin, "Atención online — gestionamos la entrega allá donde estés"], [Clock, "Lun–Vie 9:00–19:00 · Sáb 10:00–14:00"]].map(([Icon, t]) => (
        ...
        <form onSubmit={submit} className="rounded-xl p-6 h-fit" style={{ background: C.surface, border: `1px solid ${C.border}` }}>
          ...
          <label className="flex items-start gap-2 mb-4 text-xs" style={{ color: C.muted }}>
            <input type="checkbox" checked={form.acepto || false} onChange={(e) => setForm({ ...form, acepto: e.target.checked })} style={{ marginTop: 2 }} />
            <span>
              He leído y acepto la{" "}
              <button type="button" onClick={() => goto("privacidad")} style={{ color: C.accent, textDecoration: "underline" }}>Política de Privacidad</button>.
            </span>
          </label>
          {errors.acepto && <div className="text-xs mb-3" style={{ color: C.danger }}>{errors.acepto}</div>}
...
function PublicSite({ onGoLogin, vehicles }) {
  ...
  const [form, setForm] = useState({ nombre: "", email: "", telefono: "", motivo: "Compra de vehículo", mensaje: "", acepto: false });
  ...
  React.useEffect(() => {
    const titles = {
      home: "JGB Cars — Importación y venta de vehículos de Alemania",
      about: "Quiénes somos — JGB Cars",
      stock: "Stock de vehículos — JGB Cars",
      services: "Servicios — JGB Cars",
      why: "Por qué JGB Cars",
      contact: "Contacto — JGB Cars",
      "aviso-legal": "Aviso Legal — JGB Cars",
      privacidad: "Política de Privacidad — JGB Cars",
    };
    document.title = titles[section] || "JGB Cars";
  }, [section]);
  ...
  const submit = (e) => {
    ...
    if (!form.acepto) err.acepto = "Tienes que aceptar la Política de Privacidad para enviar el mensaje.";
    setErrors(err);
    if (Object.keys(err).length === 0) {
      setSent(true);
      setForm({ nombre: "", email: "", telefono: "", motivo: "Compra de vehículo", mensaje: "", acepto: false });
    }
  };
  ...
  const pages = {
    ...
    contact: <ContactPage form={form} setForm={setForm} errors={errors} sent={sent} submit={submit} goto={goto} />,
  ...
  return (
    <div className="jgb-root min-h-screen">
      ...
      <a
        href="https://wa.me/34625824554?text=Hola%2C%20me%20gustar%C3%ADa%20m%C3%A1s%20informaci%C3%B3n."
        target="_blank" rel="noopener noreferrer" aria-label="Contactar por WhatsApp"
        className="jgb-btn flex items-center justify-center"
        style={{ position: "fixed", bottom: 22, right: 22, zIndex: 60, width: 54, height: 54, borderRadius: "50%", background: "#25D366", boxShadow: "0 4px 14px rgba(0,0,0,.35)" }}
      >
        <MessageCircle size={26} color="#0B0C0F" strokeWidth={2.2} />
      </a>
      ...
      <footer className="max-w-6xl mx-auto px-5 py-10 flex flex-col md:flex-row justify-between gap-4 text-xs" style={{ color: C.mutedDim }}>
        ...
        <div className="flex gap-5">
          <button onClick={() => goto("aviso-legal")}>Aviso Legal</button>
          <button onClick={() => goto("privacidad")}>Privacidad</button>
          <a href="https://www.instagram.com/jgbcars" target="_blank" rel="noopener noreferrer">Instagram</a>
          <a href="https://www.tiktok.com/@jgbcars" target="_blank" rel="noopener noreferrer">TikTok</a>
        </div>
      </footer>
    </div>
  );
...
/* ============================================================
   DASHBOARD HOME
   ============================================================ */
function DashboardHome({ worker, vehicles }) {
  ...
  React.useEffect(() => {
    ...
    ]).then(([invRes, taskRes, evRes]) => {
      if (!active) return;
      if (!invRes.error && invRes.data) setInvoices(invRes.data);
      if (!taskRes.error && taskRes.data) setTasks(taskRes.data.map((t) => ({ ...t, desc: t.descripcion })));
  ...
  const ventasPorMes = useMemo(() => {
    const map = {};
    (vehicles || []).filter((v) => v.estado === "Vendido" && v.fVenta).forEach((v) => {
      const key = v.fVenta.slice(0, 7);
      map[key] = (map[key] || 0) + 1;
    });
    const keys = Object.keys(map).sort();
    return keys.map((k) => {
  ...
  const tareasUrgentes = tasks.filter((t) => (t.prioridad === "Urgente" || t.prioridad === "Alta") && t.estado !== "Completada");
  const proximosEventos = [...events].sort((a, b) => (a.fecha + a.hora).localeCompare(b.fecha + b.hora)).slice(0, 4);

  return (
    <div className="jgb-fade">
      <h2 className="text-2xl font-bold mb-1">Hola, {worker.name.split(" ")[0]}</h2>
      <p className="text-sm mb-6" style={{ color: C.muted }}>{loading ? "Cargando…" : "Esto es lo más relevante hoy en JGB Cars."}</p>
      ...
      <div className="grid lg:grid-cols-3 gap-4 mb-6">
        ...
        <div className="rounded-xl p-5" style={{ background: C.surface, border: `1px solid ${C.border}` }}>
          ...
          {ventasPorMes.length === 0 ? (
            <div className="text-sm py-16 text-center" style={{ color: C.mutedDim }}>Todavía no hay ventas registradas.</div>
          ) : (
          <ResponsiveContainer width="100%" height={220}>
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        <div className="rounded-xl p-5" style={{ background: C.surface, border: `1px solid ${C.border}` }}>
          ...
          {tareasUrgentes.length === 0 && <div className="text-xs" style={{ color: C.mutedDim }}>No hay tareas urgentes pendientes.</div>}
        ...
        <div className="rounded-xl p-5" style={{ background: C.surface, border: `1px solid ${C.border}` }}>
          ...
          {proximosEventos.length === 0 && <div className="text-xs" style={{ color: C.mutedDim }}>No hay eventos próximos.</div>}
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", borderBottom: "2px solid #111", paddingBottom: 16, marginBottom: 20 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 11, color: "#444" }}>info@jgbcars.com · +34 625 82 45 54</div>
                </div>
              </div>
...
function Vehiculos({ vehicles, vehiclesLoading, addVehicle, deleteVehicle, updateVehicle }) {
  ...
  const filtered = useMemo(() => {
    return vehicles
      ...
      .sort((a, b) => {
        if (sortKey === "orden") return (a.orden ?? 999999) - (b.orden ?? 999999);
        return a[sortKey] > b[sortKey] ? -1 : 1;
      });
  }, [vehicles, q, estadoF, sortKey]);

  const moveVehicle = async (id, dir) => {
    const ordenados = [...vehicles].sort((a, b) => (a.orden ?? 999999) - (b.orden ?? 999999));
    const idx = ordenados.findIndex((v) => v.id === id);
    const swapIdx = idx + dir;
    if (swapIdx < 0 || swapIdx >= ordenados.length) return;
    const a = ordenados[idx], b = ordenados[swapIdx];
    const ordenA = a.orden ?? 999999, ordenB = b.orden ?? 999999;
    await updateVehicle({ ...a, orden: ordenB });
    await updateVehicle({ ...b, orden: ordenA });
  };
    ...
    <div className="jgb-fade">
      ...
      <div className="flex items-center gap-2 flex-wrap mb-5">
        ...
        <select style={{ ...inputStyle, width: 170 }} value={sortKey} onChange={(e) => setSortKey(e.target.value)}>
          <option value="orden">Orden manual (Stock)</option>
          ...
          <div key={v.id} onClick={() => setSelected({ mode: "view", v })} role="button" tabIndex={0}
            ...
            <div className="relative" style={{ aspectRatio: "16 / 9" }}>
              ...
              <div className="absolute top-2 left-2 flex gap-1">
                <button onClick={(e) => { e.stopPropagation(); moveVehicle(v.id, -1); }} title="Subir en el Stock"
                  className="jgb-btn flex items-center justify-center rounded-lg"
                  style={{ width: 26, height: 26, background: "rgba(11,12,15,.85)", color: C.ink, border: `1px solid ${C.border}` }}>
                  <ArrowUp size={13} />
                </button>
                <button onClick={(e) => { e.stopPropagation(); moveVehicle(v.id, 1); }} title="Bajar en el Stock"
                  className="jgb-btn flex items-center justify-center rounded-lg"
                  style={{ width: 26, height: 26, background: "rgba(11,12,15,.85)", color: C.ink, border: `1px solid ${C.border}` }}>
                  <ArrowDown size={13} />
                </button>
...
function Documentos() {
  ...
  const [uploadCat, setUploadCat] = useState("Vehículos");
  ...
  const removeDoc = async (id, url) => {
    setDocs(docs.filter((x) => x.id !== id));
    await supabase.from("documents").delete().eq("id", id);
    if (url) await supabase.storage.from("documentos").remove([url]);
  };
  ...
  const handleUpload = async (e) => {
    ...
    const nuevo = { id: `D-${Date.now()}`, nombre: file.name, categoria: uploadCat, fecha: new Date().toISOString().slice(0, 10), url: path };
    const { data, error: insertError } = await supabase.from("documents").insert(nuevo).select();
    if (!insertError && data && data[0]) setDocs((prev) => [data[0], ...prev]);
    else setDocs((prev) => [nuevo, ...prev]);
    setUploading(false);
    setShowUpload(false);
    e.target.value = "";
  };
  ...
  const handleDownload = async (d) => {
    if (!d.url) return;
    const { data, error } = await supabase.storage.from("documentos").createSignedUrl(d.url, 60);
  ...
  return (
    <div className="jgb-fade">
      <div className="flex items-center justify-between mb-1 flex-wrap gap-3">
        ...
        <PrimaryBtn onClick={() => setShowUpload(true)}><Plus size={14} className="inline -mt-0.5 mr-1" />Subir archivo</PrimaryBtn>
      </div>
      <p className="text-sm mb-5" style={{ color: C.muted }}>{loading ? "Cargando…" : "Acceso restringido a usuarios autorizados."}</p>
          ...
          <tbody>
            {filtered.map((d) => (
              <tr key={d.id} className="jgb-row" style={{ borderTop: `1px solid ${C.border}` }}>
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center gap-2">
                    <button onClick={() => handleDownload(d)} style={{ color: C.muted }} title="Descargar"><Download size={15} /></button>
                    <button onClick={() => removeDoc(d.id, d.url)} style={{ color: C.danger }} title="Eliminar"><Trash2 size={15} /></button>
                  </div>
                </td>
              </tr>
            ))}
      ...
      <Modal open={showUpload} onClose={() => setShowUpload(false)} title="Subir archivo">
        <Field label="Categoría">
          <select style={inputStyle} value={uploadCat} onChange={(e) => setUploadCat(e.target.value)}>
            {cats.filter((c) => c !== "Todas").map((c) => <option key={c}>{c}</option>)}
          </select>
        </Field>
        <Field label="Archivo">
          <input type="file" style={inputStyle} onChange={handleUpload} disabled={uploading} />
        </Field>
        {uploading && <div className="text-xs" style={{ color: C.mutedDim }}>Subiendo…</div>}
      </Modal>
    </div>
  );
}
...
function PrivateArea({ worker, onLogout, vehicles, vehiclesLoading, addVehicle, deleteVehicle, updateVehicle }) {
  ...
  const pages = {
    dashboard: <DashboardHome worker={worker} vehicles={vehicles} />,
